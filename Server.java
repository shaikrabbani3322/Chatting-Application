...
public class Server implements ActionListener{
	...
	Server()
	{
		...
		ImageIcon i1 = new ImageIcon(ClassLoader.getSystemResource("icon/1b.png"));
		...
		ImageIcon i4 = new ImageIcon(ClassLoader.getSystemResource("icon/a.png"));
		...
		ImageIcon i7 = new ImageIcon(ClassLoader.getSystemResource("icon/b.png"));
		...
		ImageIcon i10 = new ImageIcon(ClassLoader.getSystemResource("icon/c.png"));
		...
		ImageIcon i13 = new ImageIcon(ClassLoader.getSystemResource("icon/d.png"));
		...
		JLabel name = new JLabel("Rabbani");
